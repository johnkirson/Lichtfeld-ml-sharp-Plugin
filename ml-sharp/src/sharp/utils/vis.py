...
def colorize_scalar_map(
    ...
    Args:
        ...
        color_map: Which color map to use. Ignored as matplotlib is removed.
    ...
    # Use grayscale instead of matplotlib colormap
    color_map_np = np.stack([scalar_map_np, scalar_map_np, scalar_map_np], axis=-1)
